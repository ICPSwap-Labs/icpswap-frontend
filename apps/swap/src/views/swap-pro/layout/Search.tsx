...
import { Box, Typography, InputAdornment, useTheme } from "@mui/material";
...
function SearchItem({ tokenInfo, infoAllTokens, onTokenClick }: SearchItemProps) {
  ...
  return (
    ...
    >
      ...
      <Typography color="text.primary" sx={{ fontSize: "16px", textAlign: "right" }}>
        {info ? formatDollarAmount(info.priceUSD, 2, true, 0.0001) : "--"}
      </Typography>

      {info ? <Proportion value={info.priceUSDChange} align="right" /> : <Typography align="right">--</Typography>}
    </Box>
  );
}
    ...
    >
      ...
      >
        <Box sx={{ width: "100%", maxWidth: "500px" }}>
          ...
          <Box sx={{ display: "flex", gap: "0 6px", margin: "16px 0 0 0", alignItems: "center" }}>
            <HotIcon />
