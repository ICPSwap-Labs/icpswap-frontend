...
import { STATE } from "types/staking-token-v1";
import upperFirst from "lodash/upperFirst";
import type { StakingPoolControllerPoolInfo } from "types/staking-token-v1";
import PoolDetails from "components/staking-token/v1/PoolDetails";
import UserStaking from "components/staking-token/v1/UserStaking";
import StakingAndClaim from "components/staking-token/v1/StakingAndClaim";
import { useStakingPoolData, useUserStakingInfo } from "hooks/staking-token/v1/calls";
