...
import { PoolData, UserStakingInfo, STATE, StakingPoolControllerPoolInfo } from "types/staking-token-v1";
import Harvest from "components/staking-token/v1/Harvest";
