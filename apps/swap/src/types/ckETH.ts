export type { EthTransaction, RetrieveEthStatus, TxFinalizedStatus } from "@icpswap/types";

export type BTCAddressType = "deposit" | "withdraw";

export type TxState = "NotFound" | "TxFinalized" | "TxSent" | "TxCreated" | "Pending";

export type DissolveTx = { hash: string | undefined; state: TxState; block_index: string; value: string };
