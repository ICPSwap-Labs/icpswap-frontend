...
const swapCanisterIdsPath = path.resolve(__dirname, "../apps/swap/src/.canister_ids.json");
const infoCanisterIdsPath = path.resolve(__dirname, "../apps/info/src/.canister_ids.json");
