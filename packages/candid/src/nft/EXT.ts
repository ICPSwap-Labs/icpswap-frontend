...
export type MetadataContainer = { blob: Uint8Array | number[] } | { data: Array<MetadataValue> } | { json: string };
...
export interface _SERVICE {
  ...
  adminRefund: ActorMethod<[string, AccountIdentifier__1, AccountIdentifier__1], string>;
  ...
  ext_marketplacePurchase: ActorMethod<[TokenIdentifier__1, bigint, AccountIdentifier__1], Result_9>;
  ...
  ext_saleOpen: ActorMethod<[Array<SalePricingGroup>, SaleRemaining, Array<AccountIdentifier__1>], boolean>;
  ...
  http_request_streaming_callback: ActorMethod<[HttpStreamingCallbackToken], HttpStreamingCallbackResponse>;
