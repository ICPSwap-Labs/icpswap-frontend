export const idlFactory = ({ IDL }: any) => {
  ...
  return IDL.Service({
    createStakingPool: IDL.Func([InitRequest], [Result_10], []),
    deleteStakingPool: IDL.Func([IDL.Principal], [Result_2], []),
    findPoolStatInfo: IDL.Func([], [Result_9], ["query"]),
    findStakingPoolPage: IDL.Func([IDL.Opt(IDL.Nat), IDL.Nat, IDL.Nat], [Result_8], ["query"]),
    getAdmins: IDL.Func([], [Result_7], ["query"]),
    getCycleInfo: IDL.Func([], [Result_6], []),
    getGlobalData: IDL.Func([], [Result_5], ["query"]),
    getInitArgs: IDL.Func([], [Result_4], ["query"]),
