...
export interface _SERVICE {
  ...
  get_blocks: ActorMethod<[{ start: bigint; length: bigint }], { blocks: Array<Block> }>;
  get_transaction: ActorMethod<[bigint], [] | [Transaction]>;
  get_transactions: ActorMethod<[{ start: bigint; length: bigint }], { transactions: Array<Transaction> }>;
