...
export type ResponseResult_3 = { ok: Page_1 } | { err: string };
...
export interface _SERVICE {
  ...
  findCreateEvents: ActorMethod<[Principal, bigint, bigint], ResponseResult_2>;
  findEventRecords: ActorMethod<[string, [] | [bigint], bigint, bigint], ResponseResult_3>;
  findUserEventRecords: ActorMethod<[Principal, [] | [string], [] | [bigint], bigint, bigint], ResponseResult_3>;
