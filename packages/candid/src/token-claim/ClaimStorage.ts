...
export type ResponseResult = { ok: ClaimEventInfo } | { err: string };
export type ResponseResult_1 = { ok: [User, string] } | { err: string };
...
export type User__1 = { principal: Principal } | { address: string };
export interface _SERVICE {
  ...
  findAllEventRecords: ActorMethod<[[] | [bigint], bigint, bigint], ResponseResult_3>;
  findAllEvents: ActorMethod<[[] | [bigint], bigint, bigint], ResponseResult_4>;
  findEventRecords: ActorMethod<[string, [] | [bigint], bigint, bigint], ResponseResult_3>;
  findUserEventRecords: ActorMethod<[User, [] | [string], [] | [bigint], bigint, bigint], ResponseResult_3>;
